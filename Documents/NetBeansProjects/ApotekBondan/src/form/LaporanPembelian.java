 ...
 * @author HP
 */
public class LaporanPembelian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(526, 181));
    ...
    try{
          tglAwal.setDateFormat(new SimpleDateFormat("yyyy-MM-dd"));
           tglAkhir.setDateFormat(new SimpleDateFormat("yyyy-MM-dd"));
	                   String NamaFile = "src/Laporan/laporanPembelian.jasper"; //Lokasi File jasper
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LaporanPembelian dialog = new LaporanPembelian();
